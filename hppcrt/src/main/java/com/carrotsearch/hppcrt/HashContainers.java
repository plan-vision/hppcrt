...
public final class HashContainers
{
    ...
    /** */
    private static void checkLoadFactor(final double loadFactor, final double minAllowedInclusive, final double maxAllowedInclusive) {
    ...
    /**
     * <p>Compute the a key perturbation value, unique per-power-of-2 capacity
     * to applied before hashing.
     */
