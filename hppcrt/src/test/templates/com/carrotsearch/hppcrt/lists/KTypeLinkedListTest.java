...
public class KTypeLinkedListTest<KType> extends AbstractKTypeTest<KType>
{
    ...
    public void testNoOverallocation() {
        ...
        //2) Preallocate to PREALLOCATED_SIZE :
        final KTypeLinkedList<KType> refContainer = new KTypeLinkedList<KType>(PREALLOCATED_SIZE);
        ...
        KTypeLinkedList<KType> clonedContainer = refContainer.clone();
        KTypeLinkedList<KType> copiedContainer = new KTypeLinkedList<KType>(refContainer);
        ...
        for (int j = 0; j < 10; j++) {
            ...
            copiedContainer = new KTypeLinkedList<KType>(copiedContainer);
