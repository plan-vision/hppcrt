...
public class KTypeCustomHashSetTest<KType> extends AbstractKTypeTest<KType>
{
    ...
    private final KTypeHashingStrategy<KType> TEST_STRATEGY = new KTypeHashingStrategy<KType>() {
        ...
        public int computeHashCode(final KType object) {
            ...
            return Internals.rehash(cast(castType(object) + KTypeCustomHashSetTest.STRIDE));
        }

        @Override
        public boolean equals(final KType o1, final KType o2) {

            return Intrinsics.equalsKType(cast(castType(o1) + KTypeCustomHashSetTest.STRIDE),
                    cast(castType(o2) + KTypeCustomHashSetTest.STRIDE));
        }
        ...
        try
        {
            ...
            Assert.assertEquals(10, this.set.removeAll(new KTypePredicate<KType>()
                ...
                public boolean apply(final KType v)
                {
                    ...
                    return v == KTypeCustomHashSetTest.this.key2 || v == KTypeCustomHashSetTest.this.key9 || v == KTypeCustomHashSetTest.this.key5;
                };
                    }));
    ...
    public void testHashCodeEquals()
    {
        ...
        Assert.assertEquals(l0, KTypeCustomHashSet.<KType> newInstance(this.TEST_STRATEGY));
    ...
    public void testHashingStrategyCloneEquals()
    {
        ...
        final KTypeCustomHashSet<KType> refSet3 = createSetWithRandomData(TEST_SIZE,
        ...
        KTypeCustomHashSet<KType> refSet4 = createSetWithRandomData(TEST_SIZE,
                new KTypeHashingStrategy<KType>() {
        ...
        KTypeCustomHashSet<KType> refSet4Image = createSetWithRandomData(TEST_SIZE,
                new KTypeHashingStrategy<KType>() {
        ...
        final KTypeCustomHashSet<KType> refSet5alwaysDifferent = createSetWithRandomData(TEST_SIZE, alwaysDifferentStrategy, TEST_SEED);
    ...
    public void testNoOverallocation() {
        ...
        //2) Preallocate to PREALLOCATED_SIZE :
        final KTypeCustomHashSet<KType> refContainer = new KTypeCustomHashSet<KType>(PREALLOCATED_SIZE, new KTypeStandardHash<KType>());
    ...
    private KTypeCustomHashSet<KType> createSetWithRandomData(final int size, final KTypeHashingStrategy<? super KType> strategy, final long randomSeed)
    {
