...
public class BlankingArraysTest
{
    ...
    public void testArrayOfObjects()
    {
        ...
        //a) Blank all a prime
        testArray = buildArray(BlankingArraysTest.COUNT_PRIME);
        ...
        final Integer[] referenceArray = buildArray(1136287);

        //d-1)
        Internals.blankObjectArray(testArray, 0, 0);
        //Check identity
        Assert.assertArrayEquals(referenceArray, testArray);
    ...
    public void testArrayOfBooleans()
    {
        ...
        //a) Blank all a prime
        testArray = buildBooleanArray(BlankingArraysTest.COUNT_PRIME);
        ...
        final boolean[] referenceArray = buildBooleanArray(1136287);
    ...
    private Integer[] buildArray(final int size) {

        final Integer[] testArray = new Integer[size];
    ...
    private boolean[] buildBooleanArray(final int size) {

        final boolean[] testArray = new boolean[size];
    ...
    private void checkBooleanArray(final boolean[] arrayToTest, final int startBlankingIndex, final int endBlankingIndex) {
        ...
        for (int i = 0; i < arrayToTest.length; i++) {
            ...
            if ((i >= startBlankingIndex) && (i < endBlankingIndex)) {
                ...
                //this is blanked
                if (arrayToTest[i]) {
                    Assert.assertTrue(Integer.toString(i), false);
                }
            }
            else {
    ...
    private void checkIntegerArray(final Integer[] arrayToTest, final int startBlankingIndex, final int endBlankingIndex) {
    ...
    private void checkBooleanArray(final boolean[] expected, final boolean[] actual) {
