 ...
 * xorshifting the result.
 * <p>
 * It is borrowed from <a href="https://github.com/OpenHFT/Koloboke">Koloboke</a>, and
 ...
 * <p>
 * Reciprocal mixing functions are borrowed from <a href="http://fastutil.di.unimi.it/">fastutil</a>.
 */
public final class PhiMix
{
    ...
    /**
     * The inverse of {@link #hash(int)}. This method is mainly useful to create unit tests.
     * 
     * @param x an integer.
     * @return a value that passed through {@link #hash(int)} would give {@code x}.
     */
    public final static int invIntHash(final int x) {
    ...
    /**
     * The inverse of {@link #hash(long)}. This method is mainly useful to create unit tests.
     * 
     * @param x a long integer.
     * @return a value that passed through {@link #hash(long)} would give {@code x}.
     */
    public final static long invLongHash(long x) {
        x ^= x >>> 32;
        x ^= x >>> 16;
