 ...
 */
public class BenchmarkHashCollisionsDirectIterationReversedAddAll extends SimpleBenchmark
{
    ...
    {
        Runner.main(BenchmarkHashCollisionsDirectIterationReversedAddAll.class, args);
    }
}
