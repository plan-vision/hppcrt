...
public class AbstractIteratorTest
{
    ...
    {
        Assert.assertEquals(Lists.newArrayList(1), AbstractIteratorTest.addAll(new RangeIterator(1, 1)));
        Assert.assertEquals(Lists.newArrayList(1, 2), AbstractIteratorTest.addAll(new RangeIterator(1, 2)));
        Assert.assertEquals(Lists.newArrayList(1, 2, 3), AbstractIteratorTest.addAll(new RangeIterator(1, 3)));
    }
